      ...
      <footer class="text-white text-center text-lg-start mt-auto" style="background-color: #23242a;">
          ...
          <div class="row mt-4">
            ...
            <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
              <ul class="fa-ul" style="margin-left: 1.65em;">
                <li class="mb-3">
                  <span class="fa-li"><i class="fas fa-home"></i></span><span class="ms-2"> {{ __('ui.Strada') }} San Giorgio Martire 2/D, 70124 Bari (IT) </span>
                </li>
                <li class="mb-3">
